...
//                System.out.println();
//                PossibleMoves possibleMoves = new PresidentPossibleMoves(president.getPlayer1(), president.getCurrentGameState(), null);
...
//                System.out.println();
//                for (Tuple tuple : president.getPlayer2().getSortedDeck(president.getPlayer2().getDeck())) {
//                    System.out.println(tuple.getNumber() + " -> " + tuple.getOccurrence());
//                }
//                System.out.println();
//                System.out.println("Please pick a correct combination of cards shown below:");
//                System.out.println();
//                PossibleMoves possibleMoves = new PresidentPossibleMoves(president.getPlayer2(), president.getCurrentGameState(), null);
//                for (Tuple tuple : possibleMoves.getPossibleActions()) {
//                    System.out.println(tuple.getNumber() + " -> " + tuple.getOccurrence());
//                }
//                System.out.println();
